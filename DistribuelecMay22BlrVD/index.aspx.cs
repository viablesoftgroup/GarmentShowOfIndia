...
namespace DistribuelecMay22BlrVD
{
    public partial class index : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            da1 = new SqlDataAdapter("select * from DISTRIBUELECVISITOR where Mobile_number='" + mobile.Text + "'", con);
            ...
            da2 = new SqlDataAdapter("select * from DISTRIBUELECVISITOR where Email='" + email.Text + "'", con);
            ...
            if (String.IsNullOrEmpty(natureoforganisation.SelectedItem.Text) || natureoforganisation.SelectedItem.Text == "-- Select --")
            {
                blnInputValid = false;
                string message = "Please select Choose your nature of organisation from Question-1.";
                string script = "window.onload = function(){ alert('";
                script += message;
                script += "')};";
                ClientScript.RegisterStartupScript(this.GetType(), "SuccessMessage", script, true);
            ...
            if (natureoforganisation.SelectedItem.Text == "Others" && String.IsNullOrEmpty(othernature.Text))
            {
                blnInputValid = false;
                string message = "Please Specify nature of organisation from Question-1.";
                string script = "window.onload = function(){ alert('";
                script += message;
                script += "')};";
                ClientScript.RegisterStartupScript(this.GetType(), "SuccessMessage", script, true);
            ...
            using (SqlCommand cmdi = new SqlCommand("insert into DISTRIBUELECVISITOR(RegID, Title, FirstName, LastName, CompanyName, Designation, Address, Address1, City, State, PostalZip, Country, PhoneCountry_Code, PhoneCity_Code, Phone_number, Country_Code, Mobile_number, Email, Website, Q1natureoforganisation, Q1othernatureoforganisation, Q2_Advance_Distribution_Management_System, Q2_Advance_Energy_Management_System, Q2_Building_Solutions_ELV_Building_Management_Fire_Safety, Q2_Cables__Accessories, Q2_Cables__Communication, Q2_Cables__Control, Q2_Cables__House_wiring, Q2_Cables__Instrumentation, Q2_Cables__Power_HT_and_LT, Q2_Cables__Specialty, Q2_Capacitors__Electrolytic, Q2_Capacitors__Power, Q2_Conductors_and_Accessories, Q2_Control_and_Relay_and_Instrumentation_Panels, Q2_Design_and_Consultancy, Q2_Energy_Meters, Q2_Engineering_Projects, Q2_Generators_Alternators_AC_and_DC, Q2_Geographical_Information_System, Q2_Grid_Analytics, Q2_Industrial_Control_and_Automation_Systems, Q2_Instrument_Transformers_Current, Q2_Instrument_Transformers_CVT, Q2_Instrument_Transformers_Voltage, Q2_Instruments_Sensing_Measuring_Indicating_Testing_etc, Q2_Insulators_Composite, Q2_Insulators_Polymeric, Q2_Insulators_Porcelain, Q2_Lighting_and_Lighting_Accessories, Q2_Motors_AC, Q2_Motors_DC, Q2_Motors_Flame_Proof, Q2_Power_Electronics_UPS_Variable_Speed_AC_DC_Drives, Q2_SCADA, Q2_Stamping_and_Laminations, Q2_Surge_Arrestors, Q2_Switchgear_and_Controlgear_LV, Q2_Switchgear_and_Controlgear_EHV_and_HV, Q2_Switchgear_and_Controlgear_MV, Q2_TELECOM_Equipment, Q2_Transformers__Distribution, Q2_Transformers__Power, Q2_Transmission_Line_Accessories_and_Hardware, Q2_Transmission_Line_Towers, Q2_Winding_Wires, Q2_Other_Products_Please_Specify, IP, ReferenceId)values(@RegID, @Title, @FirstName, @LastName, @CompanyName, @Designation, @Address, @Address1, @City, @State, @PostalZip, @Country, @PhoneCountry_Code, @PhoneCity_Code, @Phone_number, @Country_Code, @Mobile_number, @Email, @Website, @Q1natureoforganisation, @Q1othernatureoforganisation, @Q2_Advance_Distribution_Management_System, @Q2_Advance_Energy_Management_System, @Q2_Building_Solutions_ELV_Building_Management_Fire_Safety, @Q2_Cables__Accessories, @Q2_Cables__Communication, @Q2_Cables__Control, @Q2_Cables__House_wiring, @Q2_Cables__Instrumentation, @Q2_Cables__Power_HT_and_LT, @Q2_Cables__Specialty, @Q2_Capacitors__Electrolytic, @Q2_Capacitors__Power, @Q2_Conductors_and_Accessories, @Q2_Control_and_Relay_and_Instrumentation_Panels, @Q2_Design_and_Consultancy, @Q2_Energy_Meters, @Q2_Engineering_Projects, @Q2_Generators_Alternators_AC_and_DC, @Q2_Geographical_Information_System, @Q2_Grid_Analytics, @Q2_Industrial_Control_and_Automation_Systems, @Q2_Instrument_Transformers_Current, @Q2_Instrument_Transformers_CVT, @Q2_Instrument_Transformers_Voltage, @Q2_Instruments_Sensing_Measuring_Indicating_Testing_etc, @Q2_Insulators_Composite, @Q2_Insulators_Polymeric, @Q2_Insulators_Porcelain, @Q2_Lighting_and_Lighting_Accessories, @Q2_Motors_AC, @Q2_Motors_DC, @Q2_Motors_Flame_Proof, @Q2_Power_Electronics_UPS_Variable_Speed_AC_DC_Drives, @Q2_SCADA, @Q2_Stamping_and_Laminations, @Q2_Surge_Arrestors, @Q2_Switchgear_and_Controlgear_LV, @Q2_Switchgear_and_Controlgear_EHV_and_HV, @Q2_Switchgear_and_Controlgear_MV,@Q2_TELECOM_Equipment, @Q2_Transformers__Distribution, @Q2_Transformers__Power, @Q2_Transmission_Line_Accessories_and_Hardware, @Q2_Transmission_Line_Towers, @Q2_Winding_Wires, @Q2_Other_Products_Please_Specify, @IP, @ReferenceId)", con))
            {
                ...
                cmdi.Parameters.AddWithValue("@Q1natureoforganisation", natureoforganisation.SelectedItem.Text.Trim());
                cmdi.Parameters.AddWithValue("@Q1othernatureoforganisation", othernature.Text.Trim());
                cmdi.Parameters.AddWithValue("@Q2_Advance_Distribution_Management_System", BT1.Trim());
                cmdi.Parameters.AddWithValue("@Q2_Advance_Energy_Management_System", BT2.Trim());
                cmdi.Parameters.AddWithValue("@Q2_Building_Solutions_ELV_Building_Management_Fire_Safety", BT3.Trim());
                cmdi.Parameters.AddWithValue("@Q2_Cables__Accessories", BT4.Trim());
                cmdi.Parameters.AddWithValue("@Q2_Cables__Communication", BT5.Trim());
                cmdi.Parameters.AddWithValue("@Q2_Cables__Control", BT6.Trim());
                cmdi.Parameters.AddWithValue("@Q2_Cables__House_wiring", BT7.Trim());
                cmdi.Parameters.AddWithValue("@Q2_Cables__Instrumentation", BT8.Trim());
                cmdi.Parameters.AddWithValue("@Q2_Cables__Power_HT_and_LT", BT9.Trim());
                cmdi.Parameters.AddWithValue("@Q2_Cables__Specialty", BT10.Trim());
                cmdi.Parameters.AddWithValue("@Q2_Capacitors__Electrolytic", BT11.Trim());
                cmdi.Parameters.AddWithValue("@Q2_Capacitors__Power", BT12.Trim());
                cmdi.Parameters.AddWithValue("@Q2_Conductors_and_Accessories", BT13.Trim());
                cmdi.Parameters.AddWithValue("@Q2_Control_and_Relay_and_Instrumentation_Panels", BT14.Trim());
                cmdi.Parameters.AddWithValue("@Q2_Design_and_Consultancy", BT15.Trim());
                cmdi.Parameters.AddWithValue("@Q2_Energy_Meters", BT16.Trim());
                cmdi.Parameters.AddWithValue("@Q2_Engineering_Projects", BT17.Trim());
                cmdi.Parameters.AddWithValue("@Q2_Generators_Alternators_AC_and_DC", BT18.Trim());
                cmdi.Parameters.AddWithValue("@Q2_Geographical_Information_System", BT19.Trim());
                cmdi.Parameters.AddWithValue("@Q2_Grid_Analytics", BT20.Trim());
                cmdi.Parameters.AddWithValue("@Q2_Industrial_Control_and_Automation_Systems", BT21.Trim());
                cmdi.Parameters.AddWithValue("@Q2_Instrument_Transformers_Current", BT22.Trim());
                cmdi.Parameters.AddWithValue("@Q2_Instrument_Transformers_CVT", BT23.Trim());
                cmdi.Parameters.AddWithValue("@Q2_Instrument_Transformers_Voltage", BT24.Trim());
                cmdi.Parameters.AddWithValue("@Q2_Instruments_Sensing_Measuring_Indicating_Testing_etc", BT25.Trim());
                cmdi.Parameters.AddWithValue("@Q2_Insulators_Composite", BT26.Trim());
                cmdi.Parameters.AddWithValue("@Q2_Insulators_Polymeric", BT27.Trim());
                cmdi.Parameters.AddWithValue("@Q2_Insulators_Porcelain", BT28.Trim());
                cmdi.Parameters.AddWithValue("@Q2_Lighting_and_Lighting_Accessories", BT29.Trim());
                cmdi.Parameters.AddWithValue("@Q2_Motors_AC", BT30.Trim());
                cmdi.Parameters.AddWithValue("@Q2_Motors_DC", BT31.Trim());
                cmdi.Parameters.AddWithValue("@Q2_Motors_Flame_Proof", BT32.Trim());
                cmdi.Parameters.AddWithValue("@Q2_Power_Electronics_UPS_Variable_Speed_AC_DC_Drives", BT33.Trim());
                cmdi.Parameters.AddWithValue("@Q2_SCADA", BT34.Trim());
                cmdi.Parameters.AddWithValue("@Q2_Stamping_and_Laminations", BT35.Trim());
                cmdi.Parameters.AddWithValue("@Q2_Surge_Arrestors", BT36.Trim());
                cmdi.Parameters.AddWithValue("@Q2_Switchgear_and_Controlgear_LV", BT37.Trim());
                cmdi.Parameters.AddWithValue("@Q2_Switchgear_and_Controlgear_EHV_and_HV", BT38.Trim());
                cmdi.Parameters.AddWithValue("@Q2_Switchgear_and_Controlgear_MV", BT39.Trim());
                cmdi.Parameters.AddWithValue("@Q2_TELECOM_Equipment", BT40.Trim());
                cmdi.Parameters.AddWithValue("@Q2_Transformers__Distribution", BT41.Trim());
                cmdi.Parameters.AddWithValue("@Q2_Transformers__Power", BT42.Trim());
                cmdi.Parameters.AddWithValue("@Q2_Transmission_Line_Accessories_and_Hardware", BT43.Trim());
                cmdi.Parameters.AddWithValue("@Q2_Transmission_Line_Towers", BT44.Trim());
                cmdi.Parameters.AddWithValue("@Q2_Winding_Wires", BT45.Trim());
                cmdi.Parameters.AddWithValue("@Q2_Other_Products_Please_Specify", B46Other.Text.Trim());
        ...
        private void Regno()
        {
            ...
            da = new SqlDataAdapter("SELECT ISNULL(MAX(ID+1),0) AS ID FROM DISTRIBUELECVISITOR", con);
        ...
        protected void natureoforganisation_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (natureoforganisation.SelectedItem.Text == "Others")
            {

                othernature.Visible = true; 
            }
            else
            {
                City.Visible = false;
