            ...
            <div class="content-wrapper">
                ...
                <section class="content container-fluid">
                    ...
                    <div class="col-md-12 well" style="padding:7px; border-color:#90EE90; background-color:#44909D; text-align:center">
                        <font color="#ffffff" ><b>Aleady registered for Distribuelec - Buildelec - Intelect 2022? </b> </font>
     ...
     <%--<asp:DropDownList ID="country" class="form-control" runat="server" AutoPostBack = "true" OnSelectedIndexChanged = "OnSelectedIndexChanged">--%>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div id="other2" style="display: none"><asp:TextBox ID="B46Other" name="B46Other" placeholder="Please Specify" class="form-control" runat="server" Style="border-color: #085cad;"></asp:TextBox></div> </div>
