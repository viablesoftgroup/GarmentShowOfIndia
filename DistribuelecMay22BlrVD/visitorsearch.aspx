<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="visitorsearch.aspx.cs" Inherits="DistribuelecMay22BlrVD.visitorsearch" %>
            ...
            <div class="content-wrapper">
                ...
                <section class="content container-fluid">
                       ...
                       <%-- <p style="text-align: center;"><strong>Entry subject to Organizer’s discretion. Age limit 18 years and above. Please carry your visiting card for entry. </strong></p>--%>
                         ...
                         <div class="row">
                    <div class="col-md-6 form-group">&nbsp;</div></div>
                        <%--<p><strong>Please enter your infomation and proceed to the next step so we can build your Registration. </strong></p>--%>
                        <div class="row">
                    <div class="col-md-6 form-group">
                        <b>Please Enter Registered Mobile Number <font color="#FF0000" size="+1"></font></b>
                        <asp:TextBox ID="mobile" name="mobile" placeholder="Please Enter Registered Mobile Number" class="form-control" onkeyup="checkInput(this)"  maxlength="15" runat="server"></asp:TextBox>
                        <br /><asp:Label ID="Label2" runat="server" Text="" ForeColor="Red"></asp:Label>
                    </div>
                </div>
                        ...
                        <div class="row">
                         ...
                         <div class="row"> 
                            <div class="col-md-6 text-left"> <br />
                                <asp:Button ID="Button1" CssClass="btn btn-primary btn-lg" Font-Bold="true" runat="server" Text="Submit" OnClick="Button1_Click"/>
                                </div> 
                        </div>  
                        </div>
                </section>
